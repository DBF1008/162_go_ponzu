...
func editHandler(res http.ResponseWriter, req *http.Request) {
	...
	case http.MethodPost:
		...
		// collapse indexed multi-value fields (ex. checkbox/select repeaters)
		// submitted as fieldX.0, fieldX.1, ... into a single repeated key
		// fieldX: []string{value0, value1, ...} for db storage.
		restructureMultiValueFields(req.PostForm)
